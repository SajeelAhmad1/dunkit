      ...
      <main className="flex-1 pb-32">
        <div className="relative space-y-10 mt-20">
          ...
          <div className="flex justify-center space-x-4 ">
            ...
            <span className="text-lg font-semibold text-gray-500">
              <FormattedMessage
                id={"PriceInfo.gym-ownr"}
                defaultMessage={"Gym Owner"}
              />
            </span>
          </div>
          ...
          <p className="px-4 md:px-0 mb-40 flex justify-center">
            <FormattedMessage
              id={"PriceInfo.exclude"}
              defaultMessage={
                "* Excluding cases where the store is clearly negligent regarding damage or theft of clothing."
              }
            />
          </p>
          <Inquiries />
