    ...
    <div className="flex flex-col md:flex-row items-center md:justify-center space-x-0 md:space-x-6 space-y-4 md:space-y-0">
      ...
      <div className="w-3/4 md:w-1/4 border border-gray-300 rounded-lg p-4 py-12">
        <h1 className="text-4xl">
          <FormattedMessage
            id={"OwnerPriceCard.intitial"}
            defaultMessage={"Initial cost"}
          />
        </h1>
        <p className="text-gray-400 mt-2">
          <FormattedMessage
            id={"OwnerPriceCard.all-cost"}
            defaultMessage={
      ...
      <div className="w-3/4 md:w-1/4 border border-gray-300 rounded-lg p-4 py-12">
        <h1 className="text-4xl">
          <FormattedMessage
            id={"OwnerPriceCard.oprat"}
            defaultMessage={"Operating costs"}
          />
        </h1>
        <p className="text-gray-400 mt-2">
          <FormattedMessage
            id={"OwnerPriceCard.oprat-rent"}
            defaultMessage={
