    ...
    <div className="flex flex-col md:flex-row items-center md:justify-center space-x-0 md:space-x-6 space-y-4 md:space-y-0">
      ...
      <div className="w-3/4 md:w-1/4 border border-gray-300 rounded-lg p-4 py-8">
        ...
        <p className="text-lg font-medium mt-2">
          <FormattedMessage
            id={"UserPriceCard.exclud"}
            defaultMessage={"1,480 yen/month (excluding tax)"}
          />
        </p>
        <p className="text-gray-400 mt-2">
          <FormattedMessage
            id={"UserPriceCard.planlightgym"}
            defaultMessage={
          ...
          {basic.map((item, index) => (
            <div key={index} className="flex items-center gap-x-4">
              {item.available ? (
                <Check
                  size={18}
                  className="text-white bg-secondary p-0.5 rounded-full"
                />
              ) : (
                <Minus
                  size={18}
                  className="text-white bg-gray-400 p-0.5 rounded-full"
                />
              )}
      ...
      <div className="w-3/4 md:w-1/4 border border-gray-300 rounded-lg p-4 py-8">
        ...
        <p className="text-lg font-medium mt-2">
          <FormattedMessage
            id={"UserPriceCard.excludpuls"}
            defaultMessage={"1,980 yen/month (excluding tax)"}
          />
        </p>
        <p className="text-gray-400 mt-2">
          <FormattedMessage
            id={"UserPriceCard.plangym"}
            defaultMessage={
      ...
      <div className="w-3/4 md:w-1/4 border-[1.5px] border-secondary rounded-lg p-4">
        ...
        <p className="text-lg font-medium mt-2">
          <FormattedMessage
            id={"UserPriceCard.exclud-pro"}
            defaultMessage={"2,480 yen/month (excluding tax)"}
          />
        </p>
        <p className="text-gray-400 mt-2">
          <FormattedMessage
            id={"UserPriceCrad.a-plan"}
            defaultMessage={
